...
//
// The decoy is deliberately generic and boring. Swap it for whatever matches
// your day job via the CHAT_DECOY environment variable is a possible future
// tweak; for now it mimics a typical front-end build.
