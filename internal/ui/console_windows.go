...
// colors) and prints UTF-8 glyphs (» · →). Legacy Windows consoles need both of
// these turned on explicitly, or the escapes show up as literal garbage and the
// glyphs render as mojibake. This is a best-effort call: any step that fails is
// ignored, leaving behavior no worse than before.
